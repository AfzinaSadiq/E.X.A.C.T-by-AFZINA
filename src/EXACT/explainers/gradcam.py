...
class GradCAM:
    ...
    def __init__(self, model, target_layers=None, save_dir="user_saves/cam_saves"):
        self.model = model
        self.model.eval()
    ...
    def generate_cam(self, method="gradcam", input_tensor=None, targets=None):
        """
        ...
        if method not in self.cam_objects:
            ...
            self.cam_objects[method] = cam_class(self.model, self.target_layers,)
    ...
    def visualize_and_save(self, input_image, cam, method="gradcam", class_name="", save_png=False):
        """
    ...
    def explain(self, input_tensor, method="gradcam", targets=None, input_image=None, class_name="", save_png=False):
        """
        ...
        dict
            ...
            - 'method': method used
        """
        cam = self.generate_cam(method=method, input_tensor=input_tensor, targets=targets)
    ...
    def use_all_methods(self, input_tensor, methods=None, input_image=None, targets=None, save_png=False):
        """
        ...
        for method in methods:
            try:
                result = self.explain(input_tensor=input_tensor, method=method, targets=targets, input_image=input_image, save_png=save_png)
